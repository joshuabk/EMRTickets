...
class EMRrequest(models.Model):
    ...
    Request = models.CharField(max_length=800, null = True)
    Reason = models.CharField(max_length=800, default = '')
    Priority = models.CharField(max_length=20, default = '')
    Impact = models.CharField(max_length=400, default = '')
    Status = models.CharField(max_length=10, default = 'Pending')
    TimeStamp = models.DateTimeField(auto_now_add=True)
    Comment = models.CharField(max_length=600, default = '')
    ActionTaken = models.CharField(max_length=600, default = '')
